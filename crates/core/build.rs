...
const RAW_SCRIPT_ROOT: &'static str = "core.radlr";
...
fn main() -> RadlrResult<()> {
  ...
  println!("cargo:rerun-if-changed={}", grammar_root_dir.join("core").to_str().expect("Could not create str from RADLR dir path"));
