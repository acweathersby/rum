                ...
                match (&node.operands[left_op_index], &node.operands[right_op_index]) {
                  (Operation::Const(left), Operation::Const(right)) => {
                    ...
                    node.operands[op_index] = match (op_name, ty) {
                      (Op::ADD, prim_ty_f64_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<f64>() + right.convert(ty).load::<f64>())),
                      (Op::ADD, prim_ty_f32_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<f32>() + right.convert(ty).load::<f32>())),
                      (Op::ADD, prim_ty_u64_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<u64>() + right.convert(ty).load::<u64>())),
                      (Op::ADD, prim_ty_u32_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<u32>() + right.convert(ty).load::<u32>())),
                      (Op::ADD, prim_ty_u16_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<u16>() + right.convert(ty).load::<u16>())),
                      (Op::ADD, prim_ty_u8_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<u8>() + right.convert(ty).load::<u8>())),
                      (Op::ADD, prim_ty_s64_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<i64>() + right.convert(ty).load::<i64>())),
                      (Op::ADD, prim_ty_s32_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<i32>() + right.convert(ty).load::<i32>())),
                      (Op::ADD, prim_ty_s16_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<i16>() + right.convert(ty).load::<i16>())),
                      (Op::ADD, prim_ty_s8_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<i8>() + right.convert(ty).load::<i8>())),
                      //
                      (Op::SUB, prim_ty_f64_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<f64>() - right.convert(ty).load::<f64>())),
                      (Op::SUB, prim_ty_f32_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<f32>() - right.convert(ty).load::<f32>())),
                      (Op::SUB, prim_ty_u64_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<u64>() - right.convert(ty).load::<u64>())),
                      (Op::SUB, prim_ty_u32_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<u32>() - right.convert(ty).load::<u32>())),
                      (Op::SUB, prim_ty_u16_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<u16>() - right.convert(ty).load::<u16>())),
                      (Op::SUB, prim_ty_u8_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<u8>() - right.convert(ty).load::<u8>())),
                      (Op::SUB, prim_ty_s64_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<i64>() - right.convert(ty).load::<i64>())),
                      (Op::SUB, prim_ty_s32_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<i32>() - right.convert(ty).load::<i32>())),
                      (Op::SUB, prim_ty_s16_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<i16>() - right.convert(ty).load::<i16>())),
                      (Op::SUB, prim_ty_s8_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<i8>() - right.convert(ty).load::<i8>())),
                      //
                      (Op::DIV, prim_ty_f64_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<f64>() / right.convert(ty).load::<f64>())),
                      (Op::DIV, prim_ty_f32_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<f32>() / right.convert(ty).load::<f32>())),
                      (Op::DIV, prim_ty_u64_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<u64>() / right.convert(ty).load::<u64>())),
                      (Op::DIV, prim_ty_u32_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<u32>() / right.convert(ty).load::<u32>())),
                      (Op::DIV, prim_ty_u16_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<u16>() / right.convert(ty).load::<u16>())),
                      (Op::DIV, prim_ty_u8_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<u8>() / right.convert(ty).load::<u8>())),
                      (Op::DIV, prim_ty_s64_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<i64>() / right.convert(ty).load::<i64>())),
                      (Op::DIV, prim_ty_s32_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<i32>() / right.convert(ty).load::<i32>())),
                      (Op::DIV, prim_ty_s16_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<i16>() / right.convert(ty).load::<i16>())),
                      (Op::DIV, prim_ty_s8_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<i8>() / right.convert(ty).load::<i8>())),
                      //
                      (Op::MUL, prim_ty_f64_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<f64>() * right.convert(ty).load::<f64>())),
                      (Op::MUL, prim_ty_f32_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<f32>() * right.convert(ty).load::<f32>())),
                      (Op::MUL, prim_ty_u64_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<u64>() * right.convert(ty).load::<u64>())),
                      (Op::MUL, prim_ty_u32_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<u32>() * right.convert(ty).load::<u32>())),
                      (Op::MUL, prim_ty_u16_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<u16>() * right.convert(ty).load::<u16>())),
                      (Op::MUL, prim_ty_u8_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<u8>() * right.convert(ty).load::<u8>())),
                      (Op::MUL, prim_ty_s64_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<i64>() * right.convert(ty).load::<i64>())),
                      (Op::MUL, prim_ty_s32_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<i32>() * right.convert(ty).load::<i32>())),
                      (Op::MUL, prim_ty_s16_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<i16>() * right.convert(ty).load::<i16>())),
                      (Op::MUL, prim_ty_s8_new) => Operation::Const(ConstVal::new(ty, left.convert(ty).load::<i8>() * right.convert(ty).load::<i8>())),
                      _ => unreachable!(),
                    };
